...
func Trace(ctx context.Context, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Trace(args...)
}

// Tracef 输出 TRACE 级别的日志。
func Tracef(ctx context.Context, format string, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Tracef(format, args...)
}

// Debug 输出 DEBUG 级别的日志。
func Debug(ctx context.Context, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Debug(args...)
}

// Debugf 输出 DEBUG 级别的日志。
func Debugf(ctx context.Context, format string, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Debugf(format, args...)
}

// Info 输出 INFO 级别的日志。
func Info(ctx context.Context, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Info(args...)
}

// Infof 输出 INFO 级别的日志。
func Infof(ctx context.Context, format string, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Infof(format, args...)
}

// Warn 输出 WARN 级别的日志。
func Warn(ctx context.Context, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Warn(args...)
}

// Warnf 输出 WARN 级别的日志。
func Warnf(ctx context.Context, format string, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Warnf(format, args...)
}

// Error 输出 ERROR 级别的日志。
func Error(ctx context.Context, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Error(args...)
}

// Errorf 输出 ERROR 级别的日志。
func Errorf(ctx context.Context, format string, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Errorf(format, args...)
}

// Panic 输出 PANIC 级别的日志。
func Panic(ctx context.Context, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Panic(args...)
}

// Panicf 输出 PANIC 级别的日志。
func Panicf(ctx context.Context, format string, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Panicf(format, args...)
}

// Fatal 输出 FATAL 级别的日志。
func Fatal(ctx context.Context, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Fatal(args...)
}

// Fatalf 输出 FATAL 级别的日志。
func Fatalf(ctx context.Context, format string, args ...interface{}) {
	rootLogger.WithContext(ctx).WithSkip(1).Fatalf(format, args...)
}
