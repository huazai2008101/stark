...
import (
	...
	pkg1 "github.com/huazai2008101/stark/base/util/testdata/pkg/bar"
	pkg2 "github.com/huazai2008101/stark/base/util/testdata/pkg/foo"
)
...
func TestReflectType(t *testing.T) {
	...
	data := []struct {
		...
		},
		{
			...
			reflect.Struct,
			"SamePkg",
			"github.com/huazai2008101/stark/base/util/testdata/pkg/bar",
		},
		{
		...
		},
		{
			...
			reflect.Struct,
			"SamePkg",
			"github.com/huazai2008101/stark/base/util/testdata/pkg/foo",
		},
		{
