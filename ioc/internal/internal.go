...
// 类型全限定名是 github.com/huazai2008101/stark/ioc/gs.Container。因为 go
...
// IsBeanType 返回是否是 bean 类型。在 stark 里，变量的类型分为三种: bean 类
...
// bean 类型吗？根据 stark 的定义，它们不是合法的 bean 类型，但是它们是合法的
